  ...
  'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium transition-all duration-fast',
  {
    variants: {
      variant: {
        ...
        progress: 'bg-status-progress/15 text-status-progress border border-status-progress/30',
        ...
        // Type variants
        epic: 'bg-type-epic text-white shadow-xs',
        bug: 'bg-type-bug text-white shadow-xs',
        task: 'bg-type-task text-white shadow-xs',
      },
    },
    defaultVariants: {
      variant: 'default',
